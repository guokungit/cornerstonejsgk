...
```bash
yarn add @jushacornerstonejs/dicom-image-loader
```
...
```js
import cornerstoneDICOMImageLoader from '@jushacornerstonejs/dicom-image-loader/dist/dynamic-import/cornerstoneDICOMImageLoader.min.js';
```
...
resolve: {
  alias: {
    '@jushacornerstonejs/dicom-image-loader':
...
```js
 plugins: [
  new CopyWebpackPlugin([
    {
      from:
        '../../../node_modules/@jushacornerstonejs/dicom-image-loader/dist/dynamic-import',
      to: DIST_DIR,
    },
  ]),
```
...
[npm-url]: https://npmjs.org/package/@jushacornerstonejs/dicom-image-loader
[npm-version-image]: http://img.shields.io/npm/v/@jushacornerstonejs/dicom-image-loader.svg?style=flat
[npm-downloads-image]: http://img.shields.io/npm/dm/@jushacornerstonejs/dicom-image-loader.svg?style=flat
